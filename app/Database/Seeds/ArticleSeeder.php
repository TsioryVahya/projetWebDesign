...
class ArticleSeeder extends Seeder
{
    public function run()
    {
        ...
        // On vide la table pour éviter les doublons avec les nouveaux noms d'images
        ...
        $data = [
            [
                ...
                'meta_title'       => 'Conflit au Moyen-Orient : Le point sur la guerre en Iran'
            ],
            [
                ...
                'meta_title'       => 'Réforme des retraites : Le gouvernement face à la rue'
            ],
            [
                ...
                'corps'            => '<p>Les experts tirent la sonnette d\'alarme sur les conséquences cognitives et sociales d\'une exposition trop prolongée aux smartphones et réseaux sociaux dès le plus jeune âge.</p><p><img src="/uploads/articles/1774795908_addiction_ecrans.jpg" alt="Inquiétude sur l\'usage des tablettes et téléphones" width="800" height="450"></p>',
                ...
                'meta_title'       => 'Santé et écrans : Une génération en danger ?'
            ],
            [
                ...
                'meta_title'       => 'Économie : L\'inflation ronge le pouvoir d\'achat'
            ]
        ];
